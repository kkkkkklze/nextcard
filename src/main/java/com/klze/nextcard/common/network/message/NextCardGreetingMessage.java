package com.klze.nextcard.common.network.message;

import com.klze.nextcard.client.ClientPacketHandlers;
 ...
 * </ul>
 */
public class NextCardGreetingMessage {
    private static final int MAX_LENGTH = 256;

    private final String text;

    public NextCardGreetingMessage(String text) {
        this.text = text;
    }
    ...
    public static NextCardGreetingMessage decode(FriendlyByteBuf buf) {
        return new NextCardGreetingMessage(buf.readUtf(MAX_LENGTH));
    }
     ...
     */
    public static void handle(NextCardGreetingMessage message, Supplier<NetworkEvent.Context> context) {
