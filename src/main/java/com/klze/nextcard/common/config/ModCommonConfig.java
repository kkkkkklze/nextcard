package com.klze.nextcard.common.config;
...
public final class ModCommonConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> EXAMPLE_GREETING = BUILDER
            .comment("Message sent to a player when they join the server (see NextCardEvents).")
            .define("exampleGreeting", "Hello from nextcard!");
    ...
    public static String exampleGreeting = "Hello from nextcard!";
