...
import com.klze.nextcard.client.render.ModRenderLayers;
 ...
 * </ul>
 */
@Mod.EventBusSubscriber(modid = NextCard.MODID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
