package com.klze.nextcard.datagen.tag;

import com.klze.nextcard.NextCard;
import com.klze.nextcard.common.registry.ModItems;
import com.klze.nextcard.common.tags.ModItemTags;
...
public class ModItemTagsProvider extends ItemTagsProvider {
    public ModItemTagsProvider(PackOutput output,
        ...
        super(output, lookupProvider, blockTags, NextCard.MODID, existingFileHelper);
    }
