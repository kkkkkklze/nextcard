package com.example.examplemod.common.network;
 ...
 *       See {@link ExampleGreetingMessage}.</li>
...
public final class ModNetwork {
    ...
    private static final ResourceLocation CHANNEL_NAME = new ResourceLocation(ExampleMod.MODID, "main");
    ...
    public static void register() {
        ...
        int id = 0;
        newChannel.messageBuilder(ExampleGreetingMessage.class, id++, NetworkDirection.PLAY_TO_CLIENT)
                .encoder(ExampleGreetingMessage::encode)
                .decoder(ExampleGreetingMessage::decode)
                .consumerMainThread(ExampleGreetingMessage::handle)
                .add();
